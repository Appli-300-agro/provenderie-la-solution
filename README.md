# Provenderie la solution - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Provenderie la solution**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@provenderielasolution.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@provenderielasolution.cm` | `user123` | |
...
*   **Contact :** contact@provenderielasolution.cm